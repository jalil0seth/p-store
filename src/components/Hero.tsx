      ...
      <div className="container-width relative">
        <div className="text-center mb-8">
          ...
          >
            ...
            <br />
            <span className="mt-4 block">For Modern Teams</span>
          </motion.h1>
          ...
          <motion.div
            ...
            className="relative bg-white/60 backdrop-blur-xl rounded-2xl border border-gray-200/50 p-8 shadow-xl overflow-hidden"
          >
